...
// The same deny as the library's, and for the same reason — see `lib.rs`,
// where the stages and every thread they start live. It is repeated because
// this is a separate crate: an attribute there does not reach here.
//

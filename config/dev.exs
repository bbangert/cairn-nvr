...
# Database path is derived from the YAML config's data_dir (db_in_data_dir)
...
config :cairn, CairnWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "DvHJXeQBCxtcTuQFu4v3WkJMC/YosSEUtN2T8S5TXThC4pxIYy+J8c7kMHjxHHU5",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:cairn, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:cairn, ~w(--watch)]}
  ]
